      ...
      <nav className="bg-white w-full border-gray-200 px-2 z-1 sm:px-4 py-2.5 dark:bg-gray-900">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="flex md:order-2">
            <NavLink to={'/wishlist'} className="text-white sm:pr-5 pr-3 self-center sm:text-2xl text-sm">Wishlist <span>{wishItem.length}</span></NavLink>
